...
namespace Bookstore_Shop {
    ...
    public partial class BookStoreDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator, int Brand_Id, int Order_Id) {
...
namespace Bookstore_Shop.BookStoreDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([Barcode] = @Original_Barcode) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price) AND ([Discriminator] = @Original_Discriminator) AND ([Brand_Id] = @Original_Brand_Id) AND ((@IsNull_Order_Id = 1 AND [Order_Id] IS NULL) OR ([Order_Id] = @Original_Order_Id)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([Barcode], [Name], [Description], [Quantity], [Price], [Discriminator], [Brand_Id], [Order_Id]) VALUES (@Barcode, @Name, @Description, @Quantity, @Price, @Discriminator, @Brand_Id, @Order_Id);
SELECT Barcode, Name, Description, Quantity, Price, Discriminator, Brand_Id, Order_Id FROM Products WHERE (Barcode = @Barcode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Barcode] = @Barcode, [Name] = @Name, [Description] = @Description, [Quantity] = @Quantity, [Price] = @Price, [Discriminator] = @Discriminator, [Brand_Id] = @Brand_Id, [Order_Id] = @Order_Id WHERE (([Barcode] = @Original_Barcode) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price) AND ([Discriminator] = @Original_Discriminator) AND ([Brand_Id] = @Original_Brand_Id) AND ((@IsNull_Order_Id = 1 AND [Order_Id] IS NULL) OR ([Order_Id] = @Original_Order_Id)));
SELECT Barcode, Name, Description, Quantity, Price, Discriminator, Brand_Id, Order_Id FROM Products WHERE (Barcode = @Barcode)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Bookstore_Shop.Properties.Settings.Default.BookStoreConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Barcode, Name, Description, Quantity, Price, Discriminator, Brand_Id, Orde" +
                "r_Id FROM dbo.Products";
        ...
        public virtual int Delete(string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator, int Original_Brand_Id, global::System.Nullable<int> Original_Order_Id) {
        ...
        public virtual int Insert(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator, int Brand_Id, global::System.Nullable<int> Order_Id) {
            if ((Barcode == null)) {
            ...
            if ((Order_Id.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[7].Value = ((int)(Order_Id.Value));
            }
            else {
        ...
        public virtual int Update(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator, int Brand_Id, global::System.Nullable<int> Order_Id, string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator, int Original_Brand_Id, global::System.Nullable<int> Original_Order_Id) {
            if ((Barcode == null)) {
                throw new global::System.ArgumentNullException("Barcode");
            }
            else {
            ...
            if ((Order_Id.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Order_Id.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_Brand_Id));
            if ((Original_Order_Id.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[13].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_Order_Id.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, int Quantity, decimal Price, string Discriminator, int Brand_Id, global::System.Nullable<int> Order_Id, string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator, int Original_Brand_Id, global::System.Nullable<int> Original_Order_Id) {
            return this.Update(Original_Barcode, Name, Description, Quantity, Price, Discriminator, Brand_Id, Order_Id, Original_Barcode, Original_Quantity, Original_Price, Original_Discriminator, Original_Brand_Id, Original_Order_Id);
        }
    }
