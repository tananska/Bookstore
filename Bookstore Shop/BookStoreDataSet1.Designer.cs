...
namespace Bookstore_Shop.BookStoreDataSet1TableAdapters {
...
SELECT Barcode, Name, Description, Quantity, Price, Discriminator, Order_Id FROM Products WHERE (Barcode = @Barcode)";
        ...
        public virtual int Fill(BookStoreDataSet1.ProductsDataTable dataTable) {
        ...
        public virtual BookStoreDataSet1.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookStoreDataSet1.ProductsDataTable dataTable = new BookStoreDataSet1.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookStoreDataSet1.ProductsDataTable dataTable) {
