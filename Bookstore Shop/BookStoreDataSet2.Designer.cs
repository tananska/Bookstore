...
namespace Bookstore_Shop {
    ...
    public partial class BookStoreDataSet2 : global::System.Data.DataSet {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(decimal Price, string Comment, System.DateTime Created, int Status) {
...
namespace Bookstore_Shop.BookStoreDataSet2TableAdapters {
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Orders] WHERE (([Id] = @Original_Id) AND ([Price] = @Original_" +
                "Price) AND ([Created] = @Original_Created) AND ([Status] = @Original_Status))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Orders] SET [Price] = @Price, [Comment] = @Comment, [Created] = @Created, [Status] = @Status WHERE (([Id] = @Original_Id) AND ([Price] = @Original_Price) AND ([Created] = @Original_Created) AND ([Status] = @Original_Status));
SELECT Id, Price, Comment, Created, Status FROM Orders WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Price, Comment, Created, Status FROM dbo.Orders";
        ...
        public virtual int Fill(BookStoreDataSet2.OrdersDataTable dataTable) {
        ...
        public virtual BookStoreDataSet2.OrdersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookStoreDataSet2.OrdersDataTable dataTable = new BookStoreDataSet2.OrdersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookStoreDataSet2.OrdersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, decimal Original_Price, System.DateTime Original_Created, int Original_Status) {
        ...
        public virtual int Update(decimal Price, string Comment, System.DateTime Created, int Status, int Original_Id, decimal Original_Price, System.DateTime Original_Created, int Original_Status, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(decimal Price, string Comment, System.DateTime Created, int Status, int Original_Id, decimal Original_Price, System.DateTime Original_Created, int Original_Status) {
            return this.Update(Price, Comment, Created, Status, Original_Id, Original_Price, Original_Created, Original_Status, Original_Id);
        }
    }
