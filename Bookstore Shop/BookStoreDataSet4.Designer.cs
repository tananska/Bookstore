...
namespace Bookstore_Shop {
    ...
    public partial class BookStoreDataSet4 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator, int Order_Id) {
...
namespace Bookstore_Shop.BookStoreDataSet4TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([Barcode] = @Original_Barcode) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price) AND ([Discriminator] = @Original_Discriminator) AND ((@IsNull_Order_Id = 1 AND [Order_Id] IS NULL) OR ([Order_Id] = @Original_Order_Id)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([Barcode], [Name], [Description], [Quantity], [Price], [Discriminator], [Order_Id]) VALUES (@Barcode, @Name, @Description, @Quantity, @Price, @Discriminator, @Order_Id);
SELECT Barcode, Name, Description, Quantity, Price, Discriminator, Order_Id FROM Products WHERE (Barcode = @Barcode)";
...
SELECT Barcode, Name, Description, Quantity, Price, Discriminator, Order_Id FROM Products WHERE (Barcode = @Barcode)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Barcode, Name, Description, Quantity, Price, Discriminator, Order_Id FROM " +
                "dbo.Products";
        ...
        public virtual int Fill(BookStoreDataSet4.ProductsDataTable dataTable) {
        ...
        public virtual BookStoreDataSet4.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookStoreDataSet4.ProductsDataTable dataTable = new BookStoreDataSet4.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookStoreDataSet4.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator, global::System.Nullable<int> Original_Order_Id) {
        ...
        public virtual int Insert(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator, global::System.Nullable<int> Order_Id) {
            if ((Barcode == null)) {
        ...
        public virtual int Update(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator, global::System.Nullable<int> Order_Id, string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator, global::System.Nullable<int> Original_Order_Id) {
            if ((Barcode == null)) {
                throw new global::System.ArgumentNullException("Barcode");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, int Quantity, decimal Price, string Discriminator, global::System.Nullable<int> Order_Id, string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator, global::System.Nullable<int> Original_Order_Id) {
            return this.Update(Original_Barcode, Name, Description, Quantity, Price, Discriminator, Order_Id, Original_Barcode, Original_Quantity, Original_Price, Original_Discriminator, Original_Order_Id);
        }
    }
