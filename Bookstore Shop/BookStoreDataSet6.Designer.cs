...
namespace Bookstore_Shop {
    ...
    public partial class BookStoreDataSet6 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator) {
...
namespace Bookstore_Shop.BookStoreDataSet6TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Barcode] = @Original_Barcode) AND ([Quantit" +
                "y] = @Original_Quantity) AND ([Price] = @Original_Price) AND ([Discriminator] = " +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([Barcode], [Name], [Description], [Quantity], [Price], [Discriminator]) VALUES (@Barcode, @Name, @Description, @Quantity, @Price, @Discriminator);
SELECT Barcode, Name, Description, Quantity, Price, Discriminator FROM Products WHERE (Barcode = @Barcode)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Barcode] = @Barcode, [Name] = @Name, [Description] = @Description, [Quantity] = @Quantity, [Price] = @Price, [Discriminator] = @Discriminator WHERE (([Barcode] = @Original_Barcode) AND ([Quantity] = @Original_Quantity) AND ([Price] = @Original_Price) AND ([Discriminator] = @Original_Discriminator));
SELECT Barcode, Name, Description, Quantity, Price, Discriminator FROM Products WHERE (Barcode = @Barcode)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Barcode, Name, Description, Quantity, Price, Discriminator FROM dbo.Produc" +
                "ts";
        ...
        public virtual int Fill(BookStoreDataSet6.ProductsDataTable dataTable) {
        ...
        public virtual BookStoreDataSet6.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BookStoreDataSet6.ProductsDataTable dataTable = new BookStoreDataSet6.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BookStoreDataSet6.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator) {
        ...
        public virtual int Insert(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator) {
            if ((Barcode == null)) {
        ...
        public virtual int Update(string Barcode, string Name, string Description, int Quantity, decimal Price, string Discriminator, string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator) {
            if ((Barcode == null)) {
                throw new global::System.ArgumentNullException("Barcode");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, int Quantity, decimal Price, string Discriminator, string Original_Barcode, int Original_Quantity, decimal Original_Price, string Original_Discriminator) {
            return this.Update(Original_Barcode, Name, Description, Quantity, Price, Discriminator, Original_Barcode, Original_Quantity, Original_Price, Original_Discriminator);
        }
    }
